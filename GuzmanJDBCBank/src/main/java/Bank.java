...
import com.revature.db.CustomerDAO;
import com.revature.db.EmployeeDAO;
import com.revature.db.SimpleAccountDAO;
...
public class Bank {
    ...
    private List<SimpleAccount> simpleAccounts;
    ...
    public Bank(ArrayList<Customer> customers, BankAdmin bankAdmin, ArrayList<JointAccount> accounts2) {
        this.customers = CustomerDAO.fetchCustomers();
        this.employees = EmployeeDAO.fetchEmployees();
        this.bankAdmin = bankAdmin;
        this.simpleAccounts = SimpleAccountDAO.fetchSimpleAccounts();
    ...
    public void registerEmployee() {
        ...
        if(emp!= null){
            this.employees.add(EmployeeDAO.addEmployee(emp));
    ...
    public void registerCustomer() {
        ...
        if(customer!= null) {
            this.customers.add(CustomerDAO.addCustomer(customer));
    ...
    public void applyForSimpleAccount(Customer customer) {
        ...
        sa = SimpleAccountDAO.addSimpleAccount(sa);
    ...
    public void displayCustomerData() {
        ...
        if(c == null) {
            ...
            for(SimpleAccount a: SimpleAccountDAO.fetchSimpleAccountsByCustomerID(c.getId())){
    ...
    public void seePendingApproval() {
        ...
        if (SA.size() == 0) {
            ...
            for(Account a: SA){
                System.out.println((counter + 1) + " Type: " + a.getName());
    ...
    void setApproved() {
        ...
        if(SA.size() != 0 && num <= SA.size() && num > 0) {
            SimpleAccountDAO.approveAccount(SA.get(num - 1));
            SA.get(num-1).setAccountStatus(1);
