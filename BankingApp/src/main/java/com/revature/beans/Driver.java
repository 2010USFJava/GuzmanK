...
public class Driver {
	...
	public static void main(String[] args) {
        ...
        Bank bank = new Bank(new ArrayList <Customer>(), new ArrayList <Employee>(), admin, new ArrayList <SimpleAccount>(), new ArrayList <JointAccount>());
